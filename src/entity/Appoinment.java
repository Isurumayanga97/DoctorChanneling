...
public class Appoinment {
    ...
    public Appoinment(String appoinmentNum, String patientName, String patientId, String doctorName, String description, String appoinmentdate, String shedule, int patientTel) {
